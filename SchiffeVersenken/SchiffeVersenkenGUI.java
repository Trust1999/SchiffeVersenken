...
public class SchiffeVersenkenGUI extends JFrame {
	 ...
	 * wo sie von der Data true für da ist ein Schiffsteil bekommt, ein "+" hin. 
	 *  
	 * @param spieler Ein `SchiffeData`-Objekt, das den aktuellen Spieler darstellt
	 * @param matrix Eine String Matrix, das Spielfeld auf dem Schiffe gesetzt werden darstellt
	 * 
	 ...
	 * @param tabellenotizen Eine `JTable`, die das das Notizen-Spielfeld visuell darstellt
	 * 
	 * @since 24.08.2024
	 * @author Kiara Schunk
	 */
	 ...
	 * 
	 * Je nachdem wer dran war erscheint ein Pop-up, um den Nuttzern mitzuteilen, dass der andere
	 * Spieler nun dran ist. Daraufhin wechseln die Schirme, der von zuvor geht aus und der auf der
	 * anderen Seite geht an
	 * 
	 * @since 24.08.2024
	 * @author Kiara Schunk
	 */
